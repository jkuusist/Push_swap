...
PUSH_SWAP_SRCS = push_swap.c check_arg.c convert_args.c create_stack.c destroy_stack.c has_duplicate.c is_sorted.c reverse_rotate_stack.c rotate_stack.c sort_stack.c stack_peek.c stack_pop.c stack_push.c swap_elems.c
