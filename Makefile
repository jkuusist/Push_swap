...
CHECKER_SRCS = checker.c checker_print.c check_arg.c convert_args.c create_stack.c destroy_stack.c has_duplicate.c is_sorted.c print_stack.c print_stacks.c push_ab.c reverse_rotate_stack.c rev_rotate_ab.c rotate_ab.c rotate_stack.c stack_pop.c stack_push.c swap_ab.c swap_elems.c
